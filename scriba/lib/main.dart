...
import 'package:scriba/sayfalar/uygulama/home/gergin_orman_kosusu.dart';
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        "/writer2Page": (context) => WriterPage2(),
        "/writer3Page": (context) => WriterPage3(),
        "/gerginOrmanOku": (context) => GerginOrmanOku(),
        "/hikayeOku": (context) =>
