...
class BulunanHikaye extends StatefulWidget {
  const BulunanHikaye({super.key});

  @override
  State<BulunanHikaye> createState() => _BulunanHikayeState();
}

class _BulunanHikayeState extends State<BulunanHikaye> {
