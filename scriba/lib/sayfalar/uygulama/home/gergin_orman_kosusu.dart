...
class GerginOrmanOku extends StatefulWidget {
  const GerginOrmanOku({super.key});

  @override
  _GerginOrmanOkuState createState() => _GerginOrmanOkuState();
}

class _GerginOrmanOkuState extends State<GerginOrmanOku> {
