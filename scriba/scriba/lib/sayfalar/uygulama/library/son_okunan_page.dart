...
void main() {
  runApp(const SonOkunanPage());
}

class SonOkunanPage extends StatelessWidget {
  const SonOkunanPage({super.key});
        ...
        child: Padding(
          ...
          child: Column(
            children: const <Widget>[
              ...
              Text(
                'Görünüşe göre henüz bir hikaye okumadın',
              ...
              Text(
                'Son Okuduğun hikayeler burada görünecek',
                style: TextStyle(
                  color: Colors.grey,
                  fontSize: 18,
                ),
